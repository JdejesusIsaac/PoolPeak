...
export declare function mungePrivateTxParams(signedTx: string, options?: ShareTransactionOptions): {
    tx: string;
...
export declare function mungeShareBundleParams(params: ShareBundleParams): {
    targetBlock: string;
    /** Smart bundle spec version. */
