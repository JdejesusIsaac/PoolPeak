...
class Matchmaker {
    ...
    static fromNetwork(authSigner, { chainId }) {
        const network = networks_1.SupportedNetworks.getNetwork(chainId);
    ...
    */
    ...
    on(eventType, callback) {
        ...
        const eventHandler = eventType === interfaces_1.StreamEvent.Transaction ? this.onTransaction :
            eventType === interfaces_1.StreamEvent.Bundle ? this.onBundle :
    ...
    getEventHistory(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return res.map((entry) => new mungers_1.EventHistoryEntry(entry));
        });
    }
}
